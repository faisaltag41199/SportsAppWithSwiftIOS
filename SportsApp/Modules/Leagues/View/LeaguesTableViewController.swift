...
class LeaguesTableViewController : UITableViewController{
    ...
    func showData(){
        leagues = leaguesViewModel?.getData() ?? []
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let teamsURL = EndPointUrlStrings
            .getTeamsURL(sportName:sportName ?? "football",leagueKey: String(leagues[indexPath.row].leagueKey ?? 0))
        
        let eventsURL = EndPointUrlStrings
            .getEventsURL(sportName:sportName ?? "football", leagueKey: String(leagues[indexPath.row].leagueKey ?? 0))
        ...
        var selectedLeague = leagues[indexPath.row]
        selectedLeague.sportName = self.sportName ?? "football"
        LeagueDetailsDependencyProvider.league = selectedLeague
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if leagues[indexPath.row].leagueLogo != nil{
            ...
            if(indexPath.row == 0){
                print(leagues[indexPath.row].leagueLogo!)
            }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerView.headerTitle.text = "LEAGUES"
